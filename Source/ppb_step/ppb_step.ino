...
//NOTE: LED_BUILTIN and TELL_TALE use same pin. Cannot use LED
//as indicator while SET_TELLTALE() is being used
void TurnLEDOn()
{
...
void LoadInputValues()
{
    ...
    InputVals[S1STEP_IV_IDX] = 0;
    InputVals[S2STEP_IV_IDX] = 0;
    InputVals[RAMP_INFL_IV_IDX] = 0;
