...
// Processed in Mode: 7 - Menu stubs Mode
// It should not be directly edited.

//Machine generated!! Do not edit.
//Make edits to the manual code block below in the source file MDPart1.CS!!
using System;
...
namespace TestApp
{
//Menus are stored in a Dictionary of menus as they
//are created. Cannot add an identically named menu.
//the menu name only appears as the key string it is
//added to the MenuDict with.
...
//menu name becomes current.
    public partial class Form1 : Form
    {
		...
		public delegate U32 MenuDelegate(U32 P1, U32 P2, U32 P3, U32 P4);//Menu Delegate 
		...
		public void AddMenuDelegate(string DelegateName, MenuDelegate Delegate)
		{
			TheMenu.DelDict.Add(DelegateName, Delegate);
		}
...
//the following part is generated by ldfutil.exe----------------------------------------
		...
		public U32 DSetSolenoid(U32 Par1, U32 Par2, U32 Par3, U32 Par4)
		{
			return (U32)SetSolenoid((U8)Par1, (U8)Par2);
		}

		public U32 DSetStep(U32 Par1, U32 Par2, U32 Par3, U32 Par4)
		{
			SetStep((U8)Par1, (U16)Par2, (U16)Par3, (U8)Par4);
			return 0;
		}

		public U32 DProgramEEPROM(U32 Par1, U32 Par2, U32 Par3, U32 Par4)
		{
			ProgramEEPROM((U16)Par1, (U8)Par2);
			return 0;
		}

		public U32 DReadEEPROM(U32 Par1, U32 Par2, U32 Par3, U32 Par4)
		{
			return (U32)ReadEEPROM((U16)Par1);
		}
		...
		public void InitMenuDelegates()
		{
			...
			AddMenuDelegate("SetSolenoid", new MenuDelegate(DSetSolenoid));
			AddMenuDelegate("SetStep", new MenuDelegate(DSetStep));
			AddMenuDelegate("ProgramEEPROM", new MenuDelegate(DProgramEEPROM));
			AddMenuDelegate("ReadEEPROM", new MenuDelegate(DReadEEPROM));
